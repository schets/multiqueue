...
//!
//!   * It can dynamically add/remove producers, and each stream can have multiple consumers
//!
...
//!
//! In many cases, MultiQueue will be a good replacement for channels and it's broadcast capabilities
//! can replace more complex concurrency systems with a single queue.
//!
//! Queue Model:
